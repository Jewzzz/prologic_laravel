                    ...
                    <div class="">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number"
                                ...
                                placeholder="Enter Mobile"></input>
                            @error('mobile') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                        
                        <div class="mb-4">
                            <label for="exampleFormControlInput2"
                                class="block text-gray-700 text-sm font-bold mb-2">Company Name:</label>
                            <textarea
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="exampleFormControlInput2" wire:model="company_name"
                                placeholder="Enter Comapany Name"></textarea>
